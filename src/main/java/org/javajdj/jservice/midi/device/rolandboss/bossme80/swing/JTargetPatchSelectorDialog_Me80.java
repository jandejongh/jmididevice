  ...
  extends JDialog
{
    ...
    final PatchSlot_Me80.ME80_PATCH_IN_BANK initialPatchInBank)
  {
    ...
    final EnumSet<PatchSlot_Me80.ME80_BANK> userBanks
      = EnumSet.range (PatchSlot_Me80.ME80_BANK.U1, PatchSlot_Me80.ME80_BANK.U9);
    for (final PatchSlot_Me80.ME80_BANK me80_bank : userBanks)
    {
    ...
    final EnumSet<PatchSlot_Me80.ME80_PATCH_IN_BANK> userPatches
      = EnumSet.range (PatchSlot_Me80.ME80_PATCH_IN_BANK.PIB_1, PatchSlot_Me80.ME80_PATCH_IN_BANK.PIB_4);
    for (final PatchSlot_Me80.ME80_PATCH_IN_BANK me80_patch_in_bank : userPatches)
    {
  ...
  private PatchSlot_Me80.ME80_BANK me80_bank;
   ...
   * 
   */
  public final PatchSlot_Me80.ME80_BANK getBank ()
  {
    if (this.ok)
  ...
  private PatchSlot_Me80.ME80_PATCH_IN_BANK me80_patch_in_bank;
   ...
   * 
   */
  public final PatchSlot_Me80.ME80_PATCH_IN_BANK getPatchInBank ()
  {
    if (this.ok)
