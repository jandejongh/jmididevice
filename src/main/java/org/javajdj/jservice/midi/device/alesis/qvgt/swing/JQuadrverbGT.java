 ...
 * 
 */
public final class JQuadrverbGT
{
  ...
  private static final Logger LOG = Logger.getLogger (JQuadrverbGT.class.getName ());
  ...
  public final static void main (final String[] args)
  {
    SwingUtilities.invokeLater (() ->
    {
      try
      {
        final JQuadraverbGTFrame frame = new JQuadraverbGTFrame ();
