...
import org.javajdj.jservice.midi.device.alesis.qvgt.MidiDevice_Alesis_Quadraverb_GT;
 ...
 * 
 */
public class JQuadraverbGTFrame
  extends JFrame
{
  ...
  private static final Logger LOG = Logger.getLogger (JQuadraverbGTFrame.class.getName ());
  ...
  public JQuadraverbGTFrame ()
  {
    ...
    {
      JOptionPane.showMessageDialog (JQuadraverbGTFrame.this,
    ...
    final MidiDevice_Alesis_Quadraverb_GT midiDevice_Alesis_Quadraverb_GT = new MidiDevice_Alesis_Quadraverb_GT (midiService);
    final JQuadraverbGTPanel jQvGt = new JQuadraverbGTPanel (midiService, midiDevice_Alesis_Quadraverb_GT);
    final Runnable r = () ->
    {
      JQuadraverbGTFrame.this.tabbedPane.add ("Instrument: Alesis QVGT", jQvGt);
